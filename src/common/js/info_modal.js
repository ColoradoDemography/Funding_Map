...
module.exports = function(map: Object) {
    ...
    map.openModal({
        content: '<table class="abbrev">' +
            ...
            '<tr><td><span class="ttext">MJ:</span></td><td><span class="desctext">&nbsp;&nbsp;<a href="https://www.colorado.gov/pacific/dola/marijuana-impact-grant" class="blue" target="_blank" >Marijuana Impact Grants</a></span></td></tr>' +
